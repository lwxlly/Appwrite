...
const UUID = process.env.UUID || '4163f7ad-1163-447e-b37d-0ac458d71297'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nnezha.leiilin.eu.org:443';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '0jvJWdd5w49WnwfhvcZyaTS328CbqFvv';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'personal-projects-new-project-69305de7002f2e7a6581.appwrite.network';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
